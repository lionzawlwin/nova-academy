...
const List<NurseryRhymeDef> nurseryKgRhymesBank = [
  ...
  NurseryRhymeDef(
    id: 'mock-nursery-rhymes-stem-2',
    subject: 'stem',
    grade: Grade.nursery,
    titleEn: 'Sunny or Rainy?',
    titleMy: 'နေသာလား မိုးရွာလား',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 6,
    emoji: '🌦️',
    lines: [
      RhymeLine(
        emoji: '☀️',
        textEn: 'Sunny day, the sky is bright,',
        textMy: 'နေသာတဲ့နေ့မှာ ကောင်းကင်က တောက်ပနေတယ်၊',
      ),
      RhymeLine(
        emoji: '☔',
        textEn: 'Rainy day, we open umbrellas,',
        textMy: 'မိုးရွာတဲ့နေ့မှာ ထီးဖွင့်ကြတယ်၊',
      ),
      RhymeLine(
        emoji: '💨',
        textEn: 'Windy day, the leaves fly high,',
        textMy: 'လေတိုက်တဲ့နေ့မှာ အရွက်တွေ ပျံသန်းကြတယ်၊',
      ),
      RhymeLine(
        emoji: '⛅',
        textEn: 'What\'s the weather today? Let\'s go see!',
        textMy: 'ဒီနေ့ ရာသီဥတု ဘယ်လိုလဲ? သွားကြည့်ကြရအောင်!',
      ),
    ],
  ),
  NurseryRhymeDef(
    id: 'mock-kg-rhymes-stem-2',
    subject: 'stem',
    grade: Grade.kg,
    ...
    lines: [
      RhymeLine(
        emoji: '🌱',
        textEn: 'A tiny seed is in the ground,',
        textMy: 'မြေထဲမှာ မျိုးစေ့လေးတစ်ဆံ ရှိတယ်၊',
      ),
      RhymeLine(
        emoji: '💧',
        textEn: 'Give it water, give it light,',
        textMy: 'ရေလောင်းပေးပြီး နေရောင်ခြည် ပေးပါ၊',
      ),
      RhymeLine(
        emoji: '🌞',
        textEn: 'The sun shines down and warms it well,',
        textMy: 'နေရောင်ခြည်က အောက်ကို ထွန်းလင်းပြီး နွေးထွေးအောင် လုပ်ပေးတယ်၊',
      ),
      RhymeLine(
        emoji: '🌿',
        textEn: 'A little sprout pops out to grow,',
        textMy: 'အညှောက်လေးတစ်ချောင်း ပေါက်လာပြီး ကြီးထွားလာတယ်၊',
      ),
      RhymeLine(
        emoji: '🌻',
        textEn: 'Soon a flower blooms so bright!',
        textMy: 'မကြာမီ ပန်းလေးတစ်ပွင့် တောက်ပစွာ ပွင့်လာလိမ့်မယ်!',
      ),
    ],
  ),
  NurseryRhymeDef(
  ...
  NurseryRhymeDef(
    id: 'mock-nursery-rhymes-coding-2',
    subject: 'coding',
    grade: Grade.nursery,
    titleEn: 'Follow the Pattern',
    titleMy: 'ပုံစံအတိုင်း လိုက်လုပ်ကြရအောင်',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 6,
    emoji: '🔴',
    lines: [
      RhymeLine(
        emoji: '🔴',
        textEn: 'Red, blue, red, blue, watch and see,',
        textMy: 'အနီ၊ အပြာ၊ အနီ၊ အပြာ၊ ကြည့်ကြရအောင်၊',
      ),
      RhymeLine(
        emoji: '🔵',
        textEn: 'What comes next in the line?',
        textMy: 'နောက်ထပ် ဘာလာမလဲ?',
      ),
      RhymeLine(
        emoji: '🔴',
        textEn: 'Red again, then blue once more,',
        textMy: 'အနီပြန်လာမယ်၊ ပြီးရင် အပြာထပ်လာမယ်၊',
      ),
      RhymeLine(
        emoji: '🎉',
        textEn: 'You found the pattern, hooray!',
        textMy: 'ပုံစံကို ရှာတွေ့ပြီ၊ ဟိုရေ!',
      ),
    ],
  ),
  NurseryRhymeDef(
    id: 'mock-kg-rhymes-coding-2',
    subject: 'coding',
    grade: Grade.kg,
    titleEn: 'Robot, Go!',
    titleMy: 'ရိုဘော့ လှုပ်ရှားလိုက်!',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 8,
    emoji: '🤖',
    lines: [
      RhymeLine(
        emoji: '🤖',
        textEn: 'Robot, robot, walk ahead,',
        textMy: 'ရိုဘော့၊ ရိုဘော့၊ ရှေ့ကို လျှောက်ပါ၊',
      ),
      RhymeLine(
        emoji: '🔁',
        textEn: 'Do it again, and again, and again,',
        textMy: 'ထပ်ပြီး လုပ်ပါ၊ ထပ်ပြီး လုပ်ပါ၊ ထပ်ပြီး လုပ်ပါ၊',
      ),
      RhymeLine(
        emoji: '🛑',
        textEn: 'When you reach the wall, stop and wait,',
        textMy: 'နံရံကို ရောက်တဲ့အခါ ရပ်ပြီး စောင့်ပါ၊',
      ),
      RhymeLine(
        emoji: '↩️',
        textEn: 'Turn around and go back home,',
        textMy: 'ပြန်လှည့်ပြီး အိမ်ကို ပြန်သွားပါ၊',
      ),
      RhymeLine(
        emoji: '✅',
        textEn: 'Good job, robot, the task is done!',
        textMy: 'ကောင်းလိုက်တာ ရိုဘော့၊ အလုပ် ပြီးပြီ!',
      ),
    ],
  ),
  NurseryRhymeDef(
  ...
  NurseryRhymeDef(
    id: 'mock-nursery-rhymes-engineering-2',
    subject: 'engineering',
    grade: Grade.nursery,
    titleEn: 'My Toolbox',
    titleMy: 'ကျွန်တော့်ရဲ့ တူဆောင်းအိတ်',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 6,
    emoji: '🧰',
    lines: [
      RhymeLine(
        emoji: '🧰',
        textEn: 'Open the toolbox, what\'s inside?',
        textMy: 'တူဆောင်းအိတ်ကို ဖွင့်ကြည့်ရအောင်၊ ဘာတွေပါလဲ?',
      ),
      RhymeLine(
        emoji: '🔨',
        textEn: 'A hammer to knock, tap tap tap,',
        textMy: 'ခေါက်ဖို့ တူတစ်လုံး၊ ခေါက် ခေါက် ခေါက်၊',
      ),
      RhymeLine(
        emoji: '🪛',
        textEn: 'A screwdriver to twist round and round,',
        textMy: 'လှည့်ဖို့ စကရူးလိပ်တစ်ချောင်း၊ လှည့် လှည့် လှည့်၊',
      ),
      RhymeLine(
        emoji: '🔧',
        textEn: 'With our tools we build and fix,',
        textMy: 'ကျွန်တော်တို့ တူများနဲ့ တည်ဆောက်ပြီး ပြင်ဆင်ကြတယ်၊',
      ),
    ],
  ),
  NurseryRhymeDef(
    id: 'mock-kg-rhymes-engineering-2',
    subject: 'engineering',
    grade: Grade.kg,
    titleEn: 'Build a Boat',
    titleMy: 'လှေတစ်စင်း တည်ဆောက်ကြရအောင်',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 8,
    emoji: '⛵',
    lines: [
      RhymeLine(
        emoji: '🚤',
        textEn: 'Let\'s build a boat to sail the sea,',
        textMy: 'ပင်လယ်ထဲ ရွက်လွှင့်ဖို့ လှေတစ်စင်း တည်ဆောက်ကြရအောင်၊',
      ),
      RhymeLine(
        emoji: '🪵',
        textEn: 'Wood and foam, glue them tight,',
        textMy: 'သစ်သားနဲ့ ဖုန်း၊ တင်းတင်းကျပ်ကျပ် ကပ်ပါ၊',
      ),
      RhymeLine(
        emoji: '💧',
        textEn: 'Put it in the water, does it float?',
        textMy: 'ရေထဲ ချထည့်ကြည့်ရအောင်၊ မျောလား?',
      ),
      RhymeLine(
        emoji: '😅',
        textEn: 'Oops it tipped, let\'s fix the base,',
        textMy: 'အယ် ဒီလှေက ပြန်လှန်သွားပြီ၊ အောက်ခံကို ပြင်ကြရအောင်၊',
      ),
      RhymeLine(
        emoji: '⛵',
        textEn: 'Now it sails so straight and proud!',
        textMy: 'အခုတော့ ဂုဏ်ယူစွာ ဖြောင့်တန်းစွာ ရွက်လွှင့်နေပြီ!',
      ),
    ],
  ),
  NurseryRhymeDef(
  ...
  NurseryRhymeDef(
    id: 'mock-nursery-rhymes-history-2',
    subject: 'history',
    grade: Grade.nursery,
    titleEn: 'Once Upon a Kingdom',
    titleMy: 'တစ်ခါတုန်းက ဘုရင့်နိုင်ငံတော်',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 6,
    emoji: '🏰',
    lines: [
      RhymeLine(
        emoji: '🏰',
        textEn: 'Long ago there lived a king,',
        textMy: 'ရှေးအခါက ဘုရင်တစ်ပါး ရှိခဲ့တယ်၊',
      ),
      RhymeLine(
        emoji: '👑',
        textEn: 'He wore a golden crown so bright,',
        textMy: 'သူဟာ တောက်ပတဲ့ ရွှေသရဖူ ဆောင်းထားတယ်၊',
      ),
      RhymeLine(
        emoji: '🏯',
        textEn: 'He lived inside a great big castle,',
        textMy: 'သူဟာ ရဲတိုက်ကြီးထဲမှာ နေထိုင်ခဲ့တယ်၊',
      ),
      RhymeLine(
        emoji: '📯',
        textEn: 'That was long, long ago, my dear!',
        textMy: 'ဒါက အလွန်ကြာလှပြီ ရှေးအခါက ဖြစ်ပါတယ် ချစ်ရသူ!',
      ),
    ],
  ),
  NurseryRhymeDef(
    id: 'mock-kg-rhymes-history-2',
    subject: 'history',
    grade: Grade.kg,
    titleEn: 'Festivals from Long Ago',
    titleMy: 'ရှေးအခါက ပွဲတော်များ',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 8,
    emoji: '🏮',
    lines: [
      RhymeLine(
        emoji: '🏮',
        textEn: 'Long ago, families lit up lanterns bright,',
        textMy:
            'ရှေးအခါက မိသားစုများသည် ဆီမီးများကို တောက်ပစွာ ထွန်းညှိခဲ့ကြတယ်၊',
      ),
      RhymeLine(
        emoji: '🙏',
        textEn: 'They bowed to elders with a smile,',
        textMy: 'အကြီးအကဲများကို ပြုံးရွှင်စွာ ရှိခိုးခဲ့ကြတယ်၊',
      ),
      RhymeLine(
        emoji: '🥮',
        textEn: 'They shared sweet cakes with family and friends,',
        textMy: 'မိသားစုနှင့် သူငယ်ချင်းများကို အချိုပွဲများ ဝေမျှခဲ့ကြတယ်၊',
      ),
      RhymeLine(
        emoji: '🎶',
        textEn: 'They sang old songs passed down through years,',
        textMy:
            'နှစ်ပေါင်းများစွာ ဆင့်ကမ်းလာခဲ့တဲ့ သီချင်းဟောင်းများကို သီဆိုခဲ့ကြတယ်၊',
      ),
      RhymeLine(
        emoji: '💫',
        textEn: 'We still celebrate the very same way!',
        textMy: 'ကျွန်တော်တို့ အခုထိ အတူတူပဲ ကျင်းပနေဆဲပါ!',
      ),
    ],
  ),
  NurseryRhymeDef(
  ...
  NurseryRhymeDef(
    id: 'mock-nursery-rhymes-geography-2',
    subject: 'geography',
    grade: Grade.nursery,
    titleEn: 'Hot Places, Cold Places',
    titleMy: 'ပူသောနေရာများ၊ အေးသောနေရာများ',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 6,
    emoji: '🏜️',
    lines: [
      RhymeLine(
        emoji: '🏜️',
        textEn: 'The desert is hot, dry sand all around,',
        textMy: 'သဲကန္တာရက ပူပြင်းပြီး သဲသဲကြီးအနှံ့ ရှိတယ်၊',
      ),
      RhymeLine(
        emoji: '❄️',
        textEn: 'The snowy land is cold and white,',
        textMy: 'နှင်းနေရာက အေးစက်ပြီး အဖြူရောင်ဖြစ်တယ်၊',
      ),
      RhymeLine(
        emoji: '🌴',
        textEn: 'The jungle is warm with tall green trees,',
        textMy: 'တောတွင်းက နွေးထွေးပြီး စိမ်းလန်းသော သစ်ပင်ကြီးများ ရှိတယ်၊',
      ),
      RhymeLine(
        emoji: '🌍',
        textEn: 'Our world has many different lands!',
        textMy: 'ကျွန်တော်တို့ ကမ္ဘာမှာ မတူညီတဲ့ နေရာများစွာ ရှိပါတယ်!',
      ),
    ],
  ),
  NurseryRhymeDef(
    id: 'mock-kg-rhymes-geography-2',
    subject: 'geography',
    grade: Grade.kg,
    titleEn: 'From Mountain to Sea',
    titleMy: 'တောင်ထိပ်မှ ပင်လယ်သို့',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 8,
    emoji: '🏞️',
    lines: [
      RhymeLine(
        emoji: '⛰️',
        textEn: 'High on the mountain, snow starts to melt,',
        textMy: 'တောင်ထိပ်ပေါ်မှာ နှင်းတွေ အရည်ပျော်စပြုလုပ်တယ်၊',
      ),
      RhymeLine(
        emoji: '💧',
        textEn: 'It trickles down to make a stream,',
        textMy: 'ချောင်းငယ်ဖြစ်လာအောင် အောက်ကို စီးဆင်းလာတယ်၊',
      ),
      RhymeLine(
        emoji: '🏞️',
        textEn: 'The stream grows bigger, becomes a river,',
        textMy: 'ချောင်းငယ်က ကြီးထွားလာပြီး မြစ်ဖြစ်လာတယ်၊',
      ),
      RhymeLine(
        emoji: '🌊',
        textEn: 'The river flows on, past towns and fields,',
        textMy: 'မြစ်ဟာ မြို့တွေနဲ့ လယ်ကွင်းတွေကို ဖြတ်ပြီး စီးဆင်းသွားတယ်၊',
      ),
      RhymeLine(
        emoji: '🌅',
        textEn: 'Until it reaches the big blue sea!',
        textMy: 'နောက်ဆုံးတော့ ကျယ်ပြန့်တဲ့ ပင်လယ်ပြာကြီးဆီ ရောက်သွားတယ်!',
      ),
    ],
  ),
  NurseryRhymeDef(
  ...
  NurseryRhymeDef(
    id: 'mock-nursery-rhymes-computing-2',
    subject: 'computing',
    grade: Grade.nursery,
    titleEn: 'Picture on the Screen',
    titleMy: 'မျက်နှာပြင်ပေါ်က ပုံလေး',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 6,
    emoji: '🎨',
    lines: [
      RhymeLine(
        emoji: '📱',
        textEn: 'Turn it on, watch it glow,',
        textMy: 'ဖွင့်လိုက်ပါ၊ မီးလင်းလာတာ ကြည့်ပါ၊',
      ),
      RhymeLine(
        emoji: '🎨',
        textEn: 'Tap a color, red or blue,',
        textMy: 'အရောင်တစ်ခု တို့ပါ၊ အနီ ဒါမှမဟုတ် အပြာ၊',
      ),
      RhymeLine(
        emoji: '✍️',
        textEn: 'Draw a circle with your finger,',
        textMy: 'လက်ချောင်းနဲ့ စက်ဝိုင်းတစ်ခု ဆွဲပါ၊',
      ),
      RhymeLine(
        emoji: '🖼️',
        textEn: 'Look, a picture we can make!',
        textMy: 'ကြည့်ကြပါ၊ ပုံလေးတစ်ပုံ ဆွဲလို့ရပြီ!',
      ),
    ],
  ),
  NurseryRhymeDef(
    id: 'mock-kg-rhymes-computing-2',
    subject: 'computing',
    grade: Grade.kg,
    titleEn: 'Video Call with Grandma',
    titleMy: 'အဖွားနဲ့ ဗီဒီယိုခေါ်ဆိုခြင်း',
    descriptionEn: 'Sing along as each line lights up.',
    descriptionMy: 'လိုင်းတစ်ခုချင်း တောက်ပလာသည်နှင့်အမျှ အတူတကွ သီဆိုပါ။',
    starsReward: 8,
    emoji: '📷',
    lines: [
      RhymeLine(
        emoji: '📷',
        textEn: 'Click the button, see my face,',
        textMy: 'ခလုတ်ကို နှိပ်လိုက်ပါ၊ ကျွန်တော့်မျက်နှာ မြင်ရပြီ၊',
      ),
      RhymeLine(
        emoji: '🎤',
        textEn: 'Speak up loud into the mic,',
        textMy: 'မိုက်ခရိုဖုန်းထဲ ကျယ်ကျယ်ပြောပါ၊',
      ),
      RhymeLine(
        emoji: '👋',
        textEn: 'Wave hello to grandma far away,',
        textMy: 'ဝေးလံတဲ့နေရာက အဖွားကို လက်ဝှေ့ပြပါ၊',
      ),
      RhymeLine(
        emoji: '😊',
        textEn: 'She waves and smiles right back at me,',
        textMy: 'အဖွားကလည်း လက်ဝှေ့ပြန်ပြီး ပြုံးပြန်ပေးတယ်၊',
      ),
      RhymeLine(
        emoji: '💕',
        textEn: 'A video call brings us close together!',
        textMy: 'ဗီဒီယိုခေါ်ဆိုမှုက ကျွန်တော်တို့ကို နီးကပ်စေတယ်!',
      ),
    ],
  ),
];
