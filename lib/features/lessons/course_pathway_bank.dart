...
const List<CoursePathwayDef> allCoursePathways = [
  ...
  scienceYear10Pathway,
  scienceYear11Pathway,
  secondary2MathematicsPathway,
  secondary2SciencePathway,
  mathematicsYear10Pathway,
  mathematicsYear11Pathway,
  biologyYear10Pathway,
  biologyYear11Pathway,
  chemistryYear10Pathway,
  chemistryYear11Pathway,
  physicsYear10Pathway,
  physicsYear11Pathway,
  englishYear10Pathway,
  englishYear11Pathway,
  computingYear10Pathway,
  computingYear11Pathway,
  globalperspectivesYear10Pathway,
  globalperspectivesYear11Pathway,
  humanitiesYear10Pathway,
  humanitiesYear11Pathway,
